//file name: 1-50smallerlarger.c
//Asking user for two numbers between 1 and 50.
//Call them small and large.
//Use a for loop between 1 and 50 to add all the numbers which are
// ">= small" and "<= large ". And print your answer.
//10/3/18
//Prem Agarwal
